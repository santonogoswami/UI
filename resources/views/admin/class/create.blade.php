...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('All new Class') }}</div>
                    ...
                    <form action="{{ route('store.class')}}" method="post">
                      @csrf
                        <div class="mb-3">
                          ...
                          <input type="text" name="class_name" class="form-control @error('class_name') is-invalid @enderror" id="exampleInputEmail1"
